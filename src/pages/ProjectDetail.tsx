...
const ProjectDetail = () => {
  ...
  const projects: Projects = {
    1: {
      ...
      story: `Mama Hagar Kru, affectionately called “old lady” in her community, is a centenarian and mother of eight who lives with her family in Fiema, a community in Nkoranza in the Bono East Region of Ghana. She is a Sanitation and Hygiene volunteer and was previously a small-scale farmer.

Mama Hagar explains how her journey with Africa Assistance Plan began:
“I encountered AAP through our Parish Priest Rev. Father Prince Adu Poku who through his diligent engagements led to the drilling of the borehole in our community due to the water crises here in Fiema.”

During the drilling process, she participated in hygiene and sanitation training organized for church members. She shares that the training “piqued an interest in me to become an S&H advocate.”

According to Mama Hagar, the training helped her discover a hidden strength within herself. She realized she had “an innate ability to address people with boldness and courage” and that she could become “a great agent of transformation with regards to the hygiene and sanitation issues which are prevalent in Fiema despite my age.”
...
`,
    ...
    2: {
      ...
      story: `I still remember the days when water was our biggest problem in this community. We walked long distances to fetch from rivers and shallow wells, and many of our children were often sick. The day this borehole was drilled in 2012 is still a memorable one for us all.
Now it has been mechanized into a bigger water system that serves everyone. I, together with other elderly women, help manage it. We collect contributions and keep it maintained. More than that, it has become a source of employment for us; we feel respected.
Before, our days revolved around fetching water, and we had little time for anything else. Now, with water accessible near our homes, children can attend school consistently, families have more time for farming and daily activities, and the community has become healthier overall. This simple yet life-changing resource has strengthened our sense of community, giving us pride in managing it together.
Every time I see children laughing as they drink clean water or families filling their containers without fear of illness, I am reminded that this gift is more than water—it is dignity, hope, and a future for generations to come. We thank Africa Assistance Plan for not only providing water but also empowering us to take responsibility and care for our own community
`,
      impact: {
...
The situation was worsened by Tinga’s water challenges, making hygiene difficult and affecting her ability to observe religious practices.
Change began when Africa Assistance Plan (AAP), with the Assemblies of God Church and Tinga D/A School, organized a Menstrual Hygiene and WASH program. Through the training, Rashida learned that menstruation is natural, not a curse, and gained the confidence to speak up at home.
“Through the training, I realized I was not alone, and I found the courage to talk to my family,” she shares.
Although traditional beliefs still remain in her household, Rashida has started an important conversation and now encourages other girls to speak for themselves. Her story shows how education can restore dignity and help girls see menstruation as a normal part of life.
“I express my gratitude to the entire Africa Assistance Plan team for their support. I believe many girls, like me, have regained self-confidence,” Rashida says
`,
      impact: {
...
In 2014, Abraham connected Tinga to Africa Assistance Plan (AAP). Through borehole drilling, sanitation and hygiene training, and community development programs, AAP began working closely with both church and community leaders. One defining moment was the “Genius of One Conference,” which reshaped how the community viewed unity and collective responsibility.
He recalls that the training emphasized that “true change happens when everyone works together, regardless of their roles or backgrounds.” Inspired, Abraham shared the lessons with elders and leaders, leading to the formation of a Local Council of Churches Committee. This body united farmers, herders, and local leaders to address conflict through dialogue and action.
The council introduced simple community bylaws to manage cattle movement, formed a local task force to enforce them, and established a peace council to mediate disputes. Alongside peacebuilding, the council continues to promote sanitation, hygiene, and sustainable practices introduced through AAP’s programs.
Looking back, Abraham reflects with gratitude. While challenges remain, the progress gives hope. “The training provided by AAP laid a strong foundation for lasting solutions,” he says, expressing deep appreciation for the role AAP has played in restoring unity and harmony in Tinga.
`,
      impact: {
...
They encouraged us to come together and build a shared latrine for the community. After the team left, we called a general community meeting, and everyone agreed to help. In a few days, we dug a latrine that the entire community could use.
Since then, we have noticed a real change. The community feels cleaner, and there is a sense of pride in knowing that we accomplished this together. People are talking more about hygiene, washing hands regularly, and keeping our surroundings clean.
I am deeply grateful to African Assistance Plan for coming to Tainakura, teaching us, and empowering our community to make this important change and more importantly, proving us with a borehole. We are hopeful for what lies ahead.
`,
      impact: {
...
Each month, Sakina missed several days of school because of her period, just like many of her friends. They often gave other excuses for their absence. As Sakina explains, “We were unable to talk freely about why we skip school due to culture, customs and religious taboos that forbid us to even talk about menstruation and menstrual challenges openly.”
She shared the deeper struggle she faced as a young Muslim girl: “Not fasting and praying is regarded as a sin against God and disobedience to authority, but I cannot give menstruation as a reason for my inability.” Unable to ask her father for money to buy sanitary pads, Sakina relied on pieces of cloth and admits, “I sometimes feel like menstruation is a punishment from God.”
Hope came when Africa Assistance Plan intervened in her school by providing a mechanized well, a segregated VIP toilet, and rolling out a menstrual health and hygiene campaign. Through this support, Sakina says, “I now have access to free sanitary pad each month… I am confident now and I know now that menstruation is not a punishment from God.”
Today, she no longer misses school. “The anxiety I feel when I must change myself at school is a thing of the past,” she says. “The best place I want to be now when I am in that time of the month is school… I feel comfortable, included and accepted
`,
      impact: {
    ...
    7: {
      ...
      story: `The Lord has opened a great door for the Gospel in Kyebi Nkwanta. Pastor Broohm of the Church of Pentecost was invited to support a Jesus Film outreach in the community. During the outreach, 15 people gave their lives to Christ.
...
The fellowship began humbly as a cell meeting in the house of the village chief. Despite the early challenges, God remained faithful.
“By the grace of God, on 7th December 2025, we moved to a new location, a few miles away from the village, and have started normal Sunday meetings as a Church,” Pastor Broohm recounts. The growing congregation stands as a testimony of God’s work through perseverance and obedience to the Great Commission.
`,
      impact: {
