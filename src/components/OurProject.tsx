...
const MIN_PARAGRAPHS_VISIBLE = 1;
                ...
                >
                    {projectSections.map((section, index) => {
                        ...
                        return (
                            <motion.article
                                ...
                                whileHover={{ y: -4 }}
                                className="group bg-white/95 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300 h-full flex flex-col"
                            >
                                <motion.div
                  ...
                  /> */}
                                    ...
                                    <div className="absolute bottom-5 left-5 right-5">
                                        <h2 className="text-2xl sm:text-3xl font-bold text-white drop-shadow-md">{section.title}</h2>
                                        {section.subtitle && (
                                            <p className="text-sm sm:text-base text-brand-gold font-semibold mt-1 drop-shadow-md">
                                                {section.subtitle}
                                            </p>
                                        )}
                                    </div>
                                ...
                                <div className="p-6 sm:p-8 flex-1 flex flex-col">
                                    <motion.div layout className="space-y-4 text-gray-700 leading-relaxed">
