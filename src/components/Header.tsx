  ...
  <div className="relative" ref={dropdownRef}>
    <button
      ...
      className={`font-medium transition-colors duration-300 flex items-center ${
        location.pathname === '/about' || location.pathname === '/activities'
          ? 'text-brand-blue font-semibold'
          : 'text-gray-700 hover:text-brand-blue'
      }`}
    >
          ...
          <nav className="px-4 py-6 space-y-2">
            ...
            >
              <button
                ...
                className={`w-full flex items-center justify-between font-medium py-3 px-4 rounded-lg transition-all duration-200 ${
                  location.pathname === '/about' || location.pathname === '/activities'
                    ? 'bg-brand-blue/10 text-brand-blue font-semibold shadow-sm'
                    : 'text-gray-700 hover:bg-gray-50 hover:text-brand-blue'
                }`}
